...
def test_extract_domain_fixes_comma_typo():
    assert extract_target("test www.example,com") == "www.example.com"
...
def test_summarize_recon_request():
    assert "reconnaissance" in summarize_request("run recon", ["nmap_top_ports"], "example.com")
